...
Options:
    ...
    --repo OWNER/NAME   Repository (default: velaclaw-labs/velaclaw)
...
def parse_args():
    ...
    parser.add_argument(
        "--repo",
        default="velaclaw-labs/velaclaw",
        help="Repository in OWNER/NAME format (default: velaclaw-labs/velaclaw)",
    )
