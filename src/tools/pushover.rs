...
mod tests {
    ...
    async fn execute_blocks_readonly_mode() {
        ...
        let result = tool.execute(json!({"message": "hello"}), &ToolExecutionContext::default()).await.unwrap();
    ...
    async fn execute_rejects_priority_out_of_range() {
        ...
        let result = tool
            .execute(json!({"message": "hello", "priority": 5}), &ToolExecutionContext::default())
            .await
            .unwrap();
