...
VelaClaw supports Z.AI's GLM models through OpenAI-compatible endpoints.
This guide covers practical setup options that match current VelaClaw provider behavior.

## Overview

VelaClaw supports these Z.AI aliases and endpoints out of the box:
...
### Test with VelaClaw CLI

```bash
# Test agent directly
echo "Hello" | velaclaw agent
