...
## Vấn đề
VelaClaw có rate limiting (20 actions/hour) nhưng chưa có giới hạn tài nguyên. Một agent bị lỗi lặp vòng có thể:
...
Tự động tạo cgroup cho velaclaw với các giới hạn.
