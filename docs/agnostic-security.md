...
|---------|-----------|--------------|--------|
| **Base VelaClaw** | 3.4MB | <5MB | ✅ Current |
...
| Hardware | RAM | VelaClaw (base) | VelaClaw (full security) | Status |
|----------|-----|-----------------|--------------------------|--------|
...
**Even with full security, VelaClaw uses <5% of RAM on $10 boards.**

---

## 5. Agnostic Swaps: Everything Remains Pluggable

### VelaClaw's Core Promise: Swap Anything
