# VelaClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for VelaClaw edge scenarios on ESP32.
...
3. Connect UI state with VelaClaw edge/runtime messaging
...
- [VelaClaw Hardware Design](../../docs/hardware-peripherals-design.md)
