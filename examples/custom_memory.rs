//! Example: Implementing a custom Memory backend for VelaClaw
//!
...
// ── Re-define the trait types (in your app, import from velaclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 VelaClaw Memory Demo — InMemoryBackend\n");
