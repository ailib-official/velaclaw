...
## Problem
VelaClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/velaclaw/audit.key"
...
velaclaw audit --user @alice

# Show all high-risk commands
velaclaw audit --risk high

# Show violations from last 24 hours
velaclaw audit --since 24h --violations-only

# Export to JSON for analysis
velaclaw audit --format json --output audit.json
