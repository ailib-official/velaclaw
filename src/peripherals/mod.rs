...
/// Handle `velaclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: velaclaw peripheral add <board> <path>");
                println!("  Example: velaclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
