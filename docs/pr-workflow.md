# VelaClaw PR Workflow (High-Volume Collaboration)

This document defines how VelaClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to VelaClaw/project-native labels.
...
- Confirm any required identity-like wording uses VelaClaw/project-native terminology.
