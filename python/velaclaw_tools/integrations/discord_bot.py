"""
Discord bot integration for VelaClaw.
"""
...
class DiscordBot:
    """
    Discord bot powered by VelaClaw agent with LangGraph tool calling.
    ...
    def __init__(
        ...
        if not DISCORD_AVAILABLE:
            raise ImportError(
                ...
                "Install with: pip install velaclaw-tools[discord]"
            )
    ...
    def _setup_events(self):
        @self.client.event
        async def on_ready():
            print(f"VelaClaw Discord Bot ready: {self.client.user}")
