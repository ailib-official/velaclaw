...
## Problem
VelaClaw has rate limiting (20 actions/hour) but no resource caps. A runaway agent could:
...
Automatically create a cgroup for velaclaw with limits.
