"""
Tests for velaclaw-tools package.
"""
...
def test_cli_allows_interactive_without_message():
    ...
    from velaclaw_tools.__main__ import parse_args
...
async def test_invoke_in_event_loop_raises():
    ...
    from velaclaw_tools import create_agent, shell
...
async def test_shell_tool():
    ...
    from velaclaw_tools import shell
...
async def test_file_tools(tmp_path):
    ...
    from velaclaw_tools import file_read, file_write
