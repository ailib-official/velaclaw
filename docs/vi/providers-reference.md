# Tài liệu tham khảo Providers — VelaClaw
...
3. Biến môi trường dự phòng chung: `VELACLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, VelaClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, VelaClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `velaclaw models refresh --provider nvidia`
