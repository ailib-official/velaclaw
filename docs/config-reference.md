...
| Key | Default | Purpose |
|---|---|---|
| `compact_context` | `false` | When true: `bootstrap_max_chars=6000`, `rag_chunk_limit=2`, and system-prompt total budget ~24k chars (pyramid truncation drops ambient sections first). Use for smaller context windows |
