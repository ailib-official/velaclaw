...
Trang này hướng dẫn cách cài đặt và khởi tạo VelaClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài VelaClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image VelaClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.velaclaw-docker`.
