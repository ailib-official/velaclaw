...
const SNAPSHOT_HEADER: &str = "# 🧠 VelaClaw Memory Snapshot\n\n\
    > Auto-generated by VelaClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 VelaClaw Memory Snapshot

> Auto-generated by VelaClaw.
...
I am VelaClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 VelaClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
