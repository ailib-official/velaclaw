//! # VelaClaw Robot Kit
//!
//! A standalone robotics toolkit that integrates with VelaClaw for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  VelaClaw AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use velaclaw_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of VelaClaw. It defines its own
//! `Tool` trait that is compatible with VelaClaw's but doesn't require it.
//!
//! ## Safety
//!
