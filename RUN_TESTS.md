...
```bash
# Check config
cat ~/.velaclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time velaclaw channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   velaclaw daemon
   # or
   RUST_LOG=info velaclaw channel start
   ```
...
- Issues: https://github.com/theonlyhennygod/velaclaw/issues
