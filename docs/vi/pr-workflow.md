# Quy trình PR VelaClaw (Cộng tác khối lượng cao)

Tài liệu này định nghĩa cách VelaClaw xử lý khối lượng PR lớn trong khi vẫn duy trì:
...
- Nếu có ngôn ngữ giống danh tính trong test/ví dụ, cần được chuẩn hóa về nhãn gốc VelaClaw/dự án.
...
- Xác nhận bất kỳ ngôn ngữ giống danh tính nào đều sử dụng thuật ngữ gốc VelaClaw/dự án.
