//! Channel doctor / health checks (VL-REVIEW-003).
...
use super::{
    ...
    NextcloudTalkChannel, QQChannel, SignalChannel, SlackChannel, TelegramChannel, WhatsAppChannel,
};
...
pub async fn doctor_channels(config: Config) -> Result<()> {
    ...
    if let Some(ref irc) = config.channels_config.irc {
        channels.push((
            "IRC",
            Arc::new(IrcChannel::new(super::irc::IrcChannelConfig {
